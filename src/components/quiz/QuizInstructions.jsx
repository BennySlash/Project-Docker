...
const QuizInstruction = () => {
  ...
  return (
    <div className="relative flex justify-center">
      ...
      <div className=" flex flex-col instructions px-10 bg-white rounded-lg mt-16 pb-24 leading-7">
        ...
        <p className="pb-10 mx-auto">
          ...
          topics covered in the module. No daFta will be collected on the
          website regarding your responses or how many times you take the quiz.
          ...
          appropriate feedback immediately at the bottom of the screen. After
          responding to a question, click on the "Next Question" button at the
          bottom to go to the next questino. After responding to the 8th
          ...
          score for the quiz is based on your responses to all questions. If you
          respond incorrectly to a question or retake a question again and get
          the correct response, your quiz score will reflect it appropriately.
        ...
        <div className="px-10 mt-10 flex justify-center">
          <div className="buttons justify-center flex gap-x-20">
            ...
            <button
              onClick={logout}
              className="text-center p-3 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
            >
              Logout
            </button>
          </div>
